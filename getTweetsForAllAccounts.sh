./getTweets.sh translink
./getTweets.sh travelsmart
./getTweets.sh thecanadaline
./getTweets.sh skytrainlady
...
./getTweets.sh VanGreenBldgs
./getTweets.sh ParkBoard
./getTweets.sh CityOfVancouver
